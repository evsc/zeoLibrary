...
public class ZeoNight {
	...
	PApplet myParent;
	ZeoReader mr;				// myReader
	
	public Date date;			// date of night (always date from previous day)

	public int month;			// Month, with 0 representing January
	public int year;
	 ...
	 * 6 = Saturday
	 */
	public int day_of_week;		// day of the week
	public int day_relative;	// day relative to first day of nights

	public int zq; 			// ZQ score
	public int total_z;		// total sleep minutes
	public int time_to_z;		// minutes to fall asleep
	public int time_in_wake;	// minutes in wake
	public int time_in_rem;	// minutes in rem
	public int time_in_light;	// minutes in light sleep
	public int time_in_deep;	// minutes in deep sleep
	public int awakenings;		// number of awakenings
	
	/* minutes between falling asleep and waking up.
	 * differnt than total_z, as it also counts the waking minutes during the night
	 */
...
//	    System.out.println("ZeoNight "+printDate(date));
	...
	public Date getDate(String input, boolean simple) {
